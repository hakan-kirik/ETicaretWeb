...
export class HttpErrorHandlerInterceptorServiceService implements HttpInterceptor{

  constructor(private toastrService:CustomToasterService,private userAuthService: UserAuthService) { }
